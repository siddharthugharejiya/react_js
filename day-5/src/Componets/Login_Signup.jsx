    ...
    <div>  
		...
		<div class="box">
            <div class="form">
                ...
                <div class="inputBox">
                    <input type="email" required="required" onChange={(e)=>setlemail(e.target.value)}/>
                    <span>Email</span>
                    <i></i>
                </div>
                <div class="inputBox">
                    <input type="password" required="required" onChange={(e)=>setlpass(e.target.value)} />
                    <span>Password</span>
                    <i></i>
                </div>
               
                <a ><input type="submit" onClick={l}/></a>
            </div>
...
<div class="box">
            <div class="form">
                ...
                <a ><input type="submit" onClick={add}/></a>
            </div>
        </div>
 </div>
